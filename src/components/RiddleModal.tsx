...
import { X, HelpCircle, ArrowRight, Lightbulb, ChevronDown, ChevronUp, Banknote } from 'lucide-react';
                ...
                >
                  ...
                  {city.rewardImages && city.rewardImages.length > 0 ? (
                    <>
                      ...
                      {city.cryptoChequeUrl && (
                        <a
                          href={city.cryptoChequeUrl}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="w-full py-3 mb-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl font-bold hover:from-blue-600 hover:to-blue-700 transition-all shadow-lg shadow-blue-200 flex items-center justify-center gap-2 animate-pulse"
                        >
                          <Banknote size={20} />
                          Забрать награду ($10)
                        </a>
